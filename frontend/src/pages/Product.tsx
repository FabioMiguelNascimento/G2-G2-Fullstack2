...
export default function Product() {
  ...
  const productData = {
    ...
    title: "Computador Gamer RTX 1080 i7 16GB SSD 500GB",
    description:
      "Computador gamer ideal para jogos de alta performance. Equipado com uma placa de vídeo NVIDIA RTX 1080, processador Intel i7-9700K, 16GB de RAM e armazenamento SSD de 500GB. Perfeito para quem busca qualidade gráfica e velocidade.",
    price: 1299.99,
